        ...
        if ($result->num_rows > 0) {
            ...
            if ($row['cantidad'] >= $cantidad) {
                ...
                if ($conn->query($query) === TRUE) {
                    ...
                    $query = "INSERT INTO inventory_movements (material_id, tipo_movimiento, cantidad, fecha, area, localidad_origen) VALUES ('$material_id', 'salida', '$cantidad', '$fecha', '$area', '$location_id')";
                    $conn->query($query);

                    // Registrar en historial
                    $query = "INSERT INTO inventory_history (material_id, movimiento, cantidad, fecha, descripcion) VALUES ('$material_id', 'salida', '$cantidad', '$fecha', 'Salida de material a $area desde $location_id')";
                    $conn->query($query);
